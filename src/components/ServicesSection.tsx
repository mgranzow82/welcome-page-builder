...
const services = [
  {
    ...
    description: "Enterprise leadership for clear month transformation programs",
    cta: "Learn More",
  },
  {
    icon: Cloud,
    title: "Solution & Cloud Architecture",
    description: "Deliverables, shots, designs, PrinceDiameter Requests & integrate architectures",
    cta: "Learn More",
  },
  {
    icon: Network,
    title: "Integration & API Architecture",
    description: "Architecture lifecycle, strategy, patterns, business & API references",
    cta: "View More",
  },
  {
    icon: ClipboardCheck,
    title: "IT Architecture Assessments",
    description: "Expose architecture clarity, goals, and IT factors",
    cta: "View Offering",
  },
];
    ...
    <section id="services" className="py-20 px-6 lg:px-16 bg-background">
      <div className="mx-auto max-w-7xl text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto mb-14 text-lg">
          Get from "We know we must change" to a clear target,
          architecture and roadmap – fast, pragmatic, decision-ready.
        </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s) => (
            ...
            >
              ...
              <a
                href="#"
                className="flex items-center gap-1 rounded bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity"
              >
